...
<div class="detail-container">
  ...
  {#if data.latestFinancials}
    <KeyMetricsGrid
      financials={data.latestFinancials}
      population={data.municipality.population}
    />
  ...
  <div class="about-section">
    ...
    <dl class="about-grid">
      <div><dt>Province:</dt><dd>{data.municipality.province}</dd></div>
      <div><dt>Classification:</dt><dd>{data.municipality.classification ?? 'N/A'}</dd></div>
      <div><dt>Population:</dt><dd>{formatPopulation(data.municipality.population)}</dd></div>
      <div>
        <dt>Website:</dt>
        {#if data.municipality.website}
          <a href={data.municipality.website} target="_blank" rel="noopener noreferrer" class="website-link">
