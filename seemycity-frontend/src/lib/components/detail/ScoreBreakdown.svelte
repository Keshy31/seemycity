			...
			<div class="pillars-grid" transition:slide={{ duration: 250 }}>
				...
				<div class="pillar-item">
					<div class="pillar-header">
						...
						<span
							class="pillar-score"
							style="color: var({getScoreColorVarName(financials.financial_health_score)});"
							>{formatScore(financials.financial_health_score)} / 100</span
						>
					</div>
				...
				<div class="pillar-item">
					<div class="pillar-header">
						...
						<span
							class="pillar-score"
							style="color: var({getScoreColorVarName(financials.infrastructure_score)});"
							>{formatScore(financials.infrastructure_score)} / 100</span
						>
					</div>
				...
				<div class="pillar-item">
					<div class="pillar-header">
						...
						<span
							class="pillar-score"
							style="color: var({getScoreColorVarName(financials.efficiency_score)});"
							>{formatScore(financials.efficiency_score)} / 100</span
						>
					</div>
				...
				<div class="pillar-item">
					<div class="pillar-header">
						...
						<span
							class="pillar-score"
							style="color: var({getScoreColorVarName(financials.accountability_score)});"
							>{formatScore(financials.accountability_score)} / 100</span
						>
					</div>
					<ProgressBar value={financials.accountability_score} />
					<div class="pillar-metrics">
						<span
							>Audit Outcome: <strong>{getAuditOutcomeText(financials.audit_outcome)}</strong></span
						>
					</div>
				</div>
			</div>
